...
const RideOptionsCard = () => {
    ...
    return (
        <SafeAreaView style={tw`bg-white flex-grow py-1`}>
            <View>
                <TouchableOpacity 
            ...
            <View style={tw`mt-auto border-t border-gray-300 px-3`}>
               <TouchableOpacity disabled={!selected} style={tw`bg-black py-3 my-0 ${!selected && 'bg-gray-300'}`}>
